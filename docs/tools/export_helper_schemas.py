...
def _compile_exporter(repo_root: Path, cpp_path: Path, binary_path: Path, context: str = "") -> None:
    include_and_link_args = [
        ...
        "-I",
        str(repo_root / "service" / "framework" / "brookesia_service_helper" / "include"),
        "-I",
        str(repo_root / "service" / "framework" / "brookesia_service_helper" / "host_test"),
        "-I",
        str(repo_root / "service" / "framework" / "brookesia_service_manager" / "include"),
        "-pthread",
        "-o",
        str(binary_path),
    ]
