...
#if BROOKESIA_HAL_LINUX_MEDIA_BACKEND_STUB
        return audio_detail::make_stub_codec_player(output_control);
#else
...
#if BROOKESIA_HAL_LINUX_MEDIA_BACKEND_STUB
        return audio_detail::make_stub_codec_recorder();
#else
...
#if BROOKESIA_HAL_LINUX_MEDIA_BACKEND_STUB
        return audio_detail::make_stub_playback();
#else
...
#if BROOKESIA_HAL_LINUX_MEDIA_BACKEND_STUB
        return audio_detail::make_stub_encoder();
#else
...
#if BROOKESIA_HAL_LINUX_MEDIA_BACKEND_STUB
        return audio_detail::make_stub_decoder();
#else
