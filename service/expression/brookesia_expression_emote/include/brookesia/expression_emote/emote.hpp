...
public:
    static constexpr std::string_view DISPLAY_SOURCE_NAME = "Emote";
    static constexpr std::string_view DISPLAY_SOURCE_ROLE = "expression";
...
private:
    ...
    bool setup_display_source();
    void clear_display_source();
    esp_err_t submit_display_frame(int x_start, int y_start, int x_end, int y_end, const void *data);
    bool refresh_native();
