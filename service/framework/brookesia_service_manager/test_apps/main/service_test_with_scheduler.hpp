...
public:
    ...
    inline static const FunctionSchema FUNCTION_SCHEMAS[FunctionIndexMax] = {
        [FunctionIndexAdd] = {
            ...
            true,
            std::nullopt,
            FunctionReturnSchema{FunctionValueType::Number, "Sum as a number."}
        },
        [FunctionIndexDivide] = {
            "divide",
            "Divide two numbers",
            ...
            true,
            std::nullopt,
            FunctionReturnSchema{FunctionValueType::Number, "Quotient as a number."}
        },
        [FunctionIndexTestAllTypes] = {
            "test_all_types",
            ...
            true,
            std::nullopt,
            FunctionReturnSchema{FunctionValueType::Object, "Echoed parameter values as an object."}
        },
        [FunctionIndexSuspend] = {
            "suspend",
            "Suspend the service",
