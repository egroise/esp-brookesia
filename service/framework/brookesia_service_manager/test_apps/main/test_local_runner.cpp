...
BROOKESIA_TEST_CASE(test_localtestrunner_basic_functionality, "Test LocalTestRunner - basic functionality", "[service][test_runner][basic]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_with_delays, "Test LocalTestRunner - with delays", "[service][test_runner][delays]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_validation_failures, "Test LocalTestRunner - validation failures", "[service][test_runner][validation]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_error_handling, "Test LocalTestRunner - error handling", "[service][test_runner][error]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_all_parameter_types, "Test LocalTestRunner - all parameter types", "[service][test_runner][all_types]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_custom_config, "Test LocalTestRunner - custom config", "[service][test_runner][config]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_sequential_execution, "Test LocalTestRunner - sequential execution", "[service][test_runner][sequential]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_empty_test_list, "Test LocalTestRunner - empty test list", "[service][test_runner][empty]")
{
...
BROOKESIA_TEST_CASE(test_localtestrunner_stress_test, "Test LocalTestRunner - stress test", "[service][test_runner][stress]")
{
