...
- chore(build): migrate Wi-Fi service scheduler types and schema access to lightweight utility APIs.
...
- feat(repo): move Wi-Fi service into the network service category for grouped component publishing
