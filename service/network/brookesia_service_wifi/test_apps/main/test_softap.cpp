...
BROOKESIA_TEST_CASE(test_servicewifi_rapid_softap_start_and_stop, "Test ServiceWifi - rapid softap start and stop", "[service][wifi][softap][rapid]")
{
...
BROOKESIA_TEST_CASE(test_servicewifi_rapid_softap_provision_start_and_stop, "Test ServiceWifi - rapid softap provision start and stop", "[service][wifi][softap][provision][rapid]")
{
...
BROOKESIA_TEST_CASE(test_servicewifi_softap_and_connect_coexistence, "Test ServiceWifi - softap and connect coexistence", "[service][wifi][softap][connect][coexistence]")
{
...
BROOKESIA_TEST_CASE(test_servicewifi_connect_then_softap_provision_triggers_disconnect, "Test ServiceWifi - connect then softap provision triggers disconnect", "[service][wifi][softap][provision][connect][disconnect]")
{
